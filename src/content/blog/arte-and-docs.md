...
**The institutional weight isn't comparable yet.** Arte can point to an interstate treaty, a dedicated legal entity, and thirty-four years of continuous operation as evidence it will still exist next year. Docs launched only 2 years ago as part of a broader government program. That's not a criticism — most things start somewhere — but an IT director deciding whether to bet a department's documents on Docs is really asking Arte's question: will this still be here in a decade, and under what structure. Right now the honest answer is that Docs has the right instinct (own your format, don't depend on one vendor) but not yet Arte's decades of proof that the joint structure itself survives changes of government on both sides.

...
Arte marked something else too: it pushed European integration into territory it had never covered before. Everything the two countries had built together up to that point — coal and steel, the common market — was economic. Arte was the first time cultural production itself became a joint European project. 
...
**The institutional weight isn't comparable yet.** Arte can point to an interstate treaty, a dedicated legal entity, and thirty-four years of continuous operation as evidence it will still exist next year. The treaty also gives it unusual independence. Under Article 1.1, Arte answers only to its members, "to the exclusion of any intervention by public authorities, including independent authorities responsible for regulating broadcasting in the country of the seat". That's why Arcom, France's media regulator, has no authority over it despite its Strasbourg headquarters. Docs has no insulation of that kind: it lives inside two government agencies, their budgets and their ministers' priorities. Docs launched only 2 years ago as part of a broader government program. That's not a criticism — most things start somewhere — but an IT director deciding whether to bet a department's documents on Docs is really asking Arte's question: will this still be here in a decade, and under what structure. Right now the honest answer is that Docs has the right instinct (own your format, don't depend on one vendor) but not yet Arte's decades of proof that the joint structure itself survives changes of government on both sides.

## What's actually worth asking

If the mechanism — two states pooling effort into one shared institution instead of duplicating it nationally — is what makes Arte durable, the interesting question isn't whether Docs resembles Arte today. It's whether that mechanism generalizes past media into software infrastructure, and whether it needs treaty-level backing to actually last, or whether a program like LaSuite is a lighter-weight version of the same idea that can still hold.

I don't have a confident answer. If you know of other Franco-German or EU joint software efforts built on this pooling logic rather than each country running its own procurement, I'd like to hear about them — they're the closest thing to a track record we have for judging whether this works outside television. And if you want to look at the two founding artifacts side by side, the [1990 Arte treaty](https://www.legifrance.gouv.fr/jorf/id/JORFTEXT000000358363) and the [Docs' Manifesto](https://docs.la-suite.eu/manifesto.html) are an odd but genuinely useful pair to read together.
